...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Tipo de Persona - Control Entrega - 2017</title>
        <link rel="stylesheet" href="view/css/bootstrap.css">
          <script src="view/js/jquery.js"></script>
		  <script src="view/js/bootstrapValidator.min.js"></script>
		  <script src="view/js/ValidarTipoPersona.js"></script>
  ...
  <div class="row" style="background-color: #FAFAFA;">
      ...
      <form id="form-Tipo-Persona" action="<?php echo $helper->url("Tipo_Persona","InsertaPersona"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-6">
            <br>
	         ...
	         <h4><i class='glyphicon glyphicon-edit'></i> Insertar Tipo de Persona</h4>
	         </div>
		    ...
		    <div class="form-group">
		     					  ...
		     					  <label for="nombre_tipo_persona" class="control-label">Nombre Tipo de Persona</label>
                                  <input type="text" class="form-control" id="nombre_tipo_persona" name="nombre_tipo_persona" value=""  placeholder="Nombre Tipo de Persona">
                                  <span class="help-block"></span>
		    </div>
		    </div>
            </div>
       ...
       <form action="<?php echo $helper->url("Tipo_Persona","index"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-6">
     		<br>
	         ...
	         <div class="panel panel-info">
	         <div class="panel-heading">
	         <h4><i class='glyphicon glyphicon-edit'></i> Tipo Persona Registrada	</h4>
	         </div>
	         <div class="panel-body">
