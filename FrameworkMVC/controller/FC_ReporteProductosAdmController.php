...
class FC_ReporteProductosAdmController extends ControladorBase{

	public function __construct() {
		parent::__construct();
	}
   
   public function FichaAdm()
   {
   ...
   public function index(){
   	...
   	if (isset(  $_SESSION['usuario_usuarios']) )
   	{
   		...
   		$nombre_controladores = "FC_ReporteProductosAdm";
   		...
   		if (!empty($resultPer))
   		{
   				...
   				if($action == 'ajax')
   				{
   					...
   					if ($cantidadResult>0)
   					{
   						...
   						foreach ($resultSet as $res)
   						{
   							...
   							$html.='<td style="color:#000000;font-size:95%;"><span class="pull-right"><a href="index.php?controller=FC_ReporteProductosAdm&action=FichaAdm&id_productos='. $res->id_productos .'&id_entidades='. $res->id_entidades.'" target="_blank">--Ver--</a></span></td>';
   			...
   			$this->facturacion_compras("FC_ReporteProductosAdm",array(
   ...
   public function AutocompleteCodigoProductos(){
   	...
   	$where="fc_productos.codigo_productos LIKE '$codigo_productos%' AND
   	entidades.id_entidades = fc_productos.id_entidades AND fc_productos.id_entidades='$_id_entidades' ";
   ...
   public function AutocompleteNombreProductos(){
   	...
   	$where="fc_productos.nombre_productos LIKE '$nombre_productos%' AND
   	entidades.id_entidades = fc_productos.id_entidades AND fc_productos.id_entidades='$_id_entidades'";
